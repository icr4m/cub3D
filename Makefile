...
SRCS_EXEC = $(addprefix srcs/exec/, cast_curseur.c cast_rayons.c draw_minimap.c cast_rayons_utils.c game_loop.c player_moves.c input_manager.c render_wall.c render_wall_utils.c start_game.c)
