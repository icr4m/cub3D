...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/07 12:32:03 by ijaber            #+#    #+#             */
/*   Updated: 2024/12/07 17:36:50 by ijaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/01 08:28:43 by ijaber            #+#    #+#             */
/*   Updated: 2024/12/07 17:36:18 by ijaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/21 16:02:07 by ijaber            #+#    #+#             */
/*   Updated: 2024/12/07 16:33:40 by ijaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/07 12:32:03 by ijaber            #+#    #+#             */
/*   Updated: 2024/12/08 09:37:59 by ijaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/01 08:28:43 by ijaber            #+#    #+#             */
/*   Updated: 2024/12/08 09:34:12 by ijaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/07 12:32:03 by ijaber            #+#    #+#             */
/*   Updated: 2024/12/08 10:05:18 by ijaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_circle(t_data *data)
{
	...
	center_y = 100;
	radius = 80;
	// Premier passage : dessiner le fond du cercle
	y = center_y - radius;
	while (y <= center_y + radius)
	{
		x = center_x - radius;
		while (x <= center_x + radius)
		{
			...
			if (distance <= radius)
			{
				// Calculer la position relative dans la carte
				rel_x = (x - center_x) / (float)radius * 5;
				rel_y = (y - center_y) / (float)radius * 5;
				// Position du joueur sur la carte
				map_x = floor(data->player->co.co_x / TILE_SIZE + rel_x);
				map_y = floor(data->player->co.co_y / TILE_SIZE + rel_y);
				// Vérifier les limites de la carte
				if (map_x >= 0 && map_y >= 0 && map_x < (int)data->amount_c
					&& map_y < (int)(data->amount_l - data->l_map_start))
				{
					// Colorer selon le type de case
					if (data->map_2d[map_y][map_x] == 1)
					...
					// Porte (orange)
						...
						my_mlx_pixel_put(data, x, y, 0xFFFFFFFF); // Sol (blanc)
				}
	...
	// Dessiner le point rouge représentant le joueur (3x3)
	for (int py = -1; py <= 1; py++)
	{
		for (int px = -1; px <= 1; px++)
		{
			my_mlx_pixel_put(data, center_x + px, center_y + py, 0xFF000000);
		}
	}
	// Dessiner la direction du regard du joueur
	line_length = 13;
	end_x = center_x + cos(data->player->angle) * line_length;
	end_y = center_y + sin(data->player->angle) * line_length;
	// Ligne de direction simple
	for (float t = 0; t <= 1; t += 0.01)
	{
		line_x = center_x + (end_x - center_x) * t;
		line_y = center_y + (end_y - center_y) * t;
		my_mlx_pixel_put(data, line_x, line_y, 0xFF000000);
	}
}
/* ************************************************************************** */
/*                                                                            */
